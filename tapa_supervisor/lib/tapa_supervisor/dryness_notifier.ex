defmodule TapaSupervisor.DrynessNotifier do
  ...
  def init(options) do
    tree_store = Keyword.get(options, :tree_store, TapaSupervisor.TreeStore)
    user_store = Keyword.get(options, :user_store, TapaSupervisor.UserStore)
    email_sender = Keyword.get(options, :email_sender, TapaSupervisor.EmailSender)
